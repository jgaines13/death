view: fips_codes {
  ...
  dimension: countyfp {
    type: string
    sql: case when char_length(${TABLE}.countyfp) = 3 then ${TABLE}.countyfp
  ...
  dimension: statefp {
    type: string
    sql: case when char_length(${TABLE}.statefips) = 2 then ${TABLE}.statefips
  ...
  dimension: fip_code {
    ...
    html: {{ countyname._rendered_value }}
      ;;
  }
